        ...
        <div className="text-center w-full max-w-sm">
          ...
          {mode === "choose" ? (
            <div className="space-y-4">
              <button 
                onClick={liffLogin}
                className="w-full flex items-center justify-center gap-3 rounded-2xl bg-[#06C755] px-8 py-4 font-bold text-white shadow-lg shadow-emerald-900/10 transition-all hover:bg-[#05b34c] active:scale-95"
              >
